...
declare class MfaClient {
     ...
     * ```
     */
    deleteAuthenticator(options: DeleteAuthenticatorOptions, requestOptions?: RequestOptions): Promise<void>;
    /**
     ...
     */
    verify(options: MfaVerifyOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    verify(options: MfaVerifyOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
}
...
declare class PasskeyClient {
     ...
     * ```
     */
    register(options: PasskeySignupChallengeOptions, requestOptions?: RequestOptions): Promise<PasskeySignupChallengeResponse>;
    /**
     ...
     * ```
     */
    challenge(options?: PasskeyLoginChallengeOptions, requestOptions?: RequestOptions): Promise<PasskeyLoginChallengeResponse>;
    /**
     ...
     * ```
     */
    getTokenByPasskey(options: GetTokenByPasskeyOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByPasskey(options: GetTokenByPasskeyOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
}
...
declare class PasswordlessClient {
    ...
    sendEmail(options: SendEmailOptions, requestOptions?: RequestOptions): Promise<void>;
    /**
    ...
    sendSms(options: SendSmsOptions, requestOptions?: RequestOptions): Promise<void>;
    /**
     ...
     * ```
     */
    challengeWithEmail(options: ChallengeWithEmailOptions, requestOptions?: RequestOptions): Promise<PasswordlessChallenge>;
    /**
     ...
     * ```
     */
    challengeWithPhoneNumber(options: ChallengeWithPhoneNumberOptions, requestOptions?: RequestOptions): Promise<PasswordlessChallenge>;
    /**
     ...
     * ```
     */
    getTokenByPasswordlessDbConnection(options: TokenByPasswordlessDbConnectionOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByPasswordlessDbConnection(options: TokenByPasswordlessDbConnectionOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
}
...
declare class DatabaseClient {
    ...
    signUp(options: SignUpOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<SignUpResult>>;
    signUp(options: SignUpOptions, requestOptions?: RequestOptions): Promise<SignUpResult>;
    /**
    ...
    changePassword(options: ChangePasswordOptions, requestOptions?: RequestOptions): Promise<string>;
}
 ...
 * ```
 */
declare class AnonymousSessionClient {
    #private;
    /**
     ...
     * ```
     */
    getAccessToken(options?: GetAnonymousAccessTokenOptions): Promise<AnonymousSession>;
    /**
...
declare class AuthClient {
     ...
     */
    anonymous: AnonymousSessionClient;
     ...
     * @returns A Promise, resolving to the TokenResponse as returned from Auth0.
     */
    backchannelAuthentication(options: BackchannelAuthenticationOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    backchannelAuthentication(options: BackchannelAuthenticationOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     */
    initiateBackchannelAuthentication(options: BackchannelAuthenticationOptions, requestOptions?: RequestOptions): Promise<{
        authReqId: string;
        expiresIn: number;
    ...
    backchannelAuthenticationGrant({ authReqId }: {
        authReqId: string;
    }, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * ```
     */
    getTokenForConnection(options: TokenForConnectionOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenForConnection(options: TokenForConnectionOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     * @overload
     ...
     * ```
     */
    exchangeToken(options: ExchangeProfileOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     * @overload
     ...
     * ```
     */
    exchangeToken(options: TokenVaultExchangeOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * @param requestOptions Optional per-request options (signal, headers, customFetch).
     */
    exchangeToken(options: ExchangeProfileOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    exchangeToken(options: TokenVaultExchangeOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    exchangeToken(options: ExchangeProfileOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    exchangeToken(options: TokenVaultExchangeOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
     ...
     * @returns A Promise, resolving to the TokenResponse as returned from Auth0.
     */
    getTokenByCode(url: URL, options: TokenByCodeOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByCode(url: URL, options: TokenByCodeOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * @param requestOptions Optional per-request options (signal, headers, customFetch).
     */
    getTokenByMagicLinkCode(url: URL, options: TokenByMagicLinkCodeOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByMagicLinkCode(url: URL, options?: TokenByMagicLinkCodeOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * @returns A Promise, resolving to the TokenResponse as returned from Auth0.
     */
    getTokenByRefreshToken(options: TokenByRefreshTokenOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByRefreshToken(options: TokenByRefreshTokenOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     */
    revokeToken(options: RevokeTokenOptions, requestOptions?: RequestOptions): Promise<void>;
    /**
     ...
     * ```
     */
    getUserInfo(options: GetUserInfoOptions, requestOptions?: RequestOptions): Promise<UserInfoResponse>;
    /**
     ...
     * @returns A Promise, resolving to the TokenResponse as returned from Auth0.
     */
    getTokenByPassword(options: TokenByPasswordOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByPassword(options: TokenByPasswordOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * ```
     */
    getTokenByPasswordlessEmail(options: TokenByPasswordlessEmailOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByPasswordlessEmail(options: TokenByPasswordlessEmailOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * ```
     */
    getTokenByPasswordlessSms(options: TokenByPasswordlessSmsOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByPasswordlessSms(options: TokenByPasswordlessSmsOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
     ...
     * @returns A Promise, resolving to the TokenResponse as returned from Auth0.
     */
    getTokenByClientCredentials(options: TokenByClientCredentialsOptions & {
        fullResponse: true;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<TokenResponse>>;
    getTokenByClientCredentials(options: TokenByClientCredentialsOptions, requestOptions?: RequestOptions): Promise<TokenResponse>;
    /**
 ...
 */
declare class UserInfoError extends ApiError {
    constructor(message: string, cause?: OAuth2Error);
}
/**
 ...
 */
declare class MissingCapturedResponseError extends Error {
    code: string;
    constructor(message?: string);
}
 ...
 */
interface AnonymousSessionApiErrorResponse {
    error: string;
    error_description: string;
    message?: string;
}
 ...
 */
type AnonymousSessionErrorCode = 'session_expired' | 'invalid_session_token' | 'unauthorized_client' | 'feature_not_enabled' | 'invalid_client' | 'invalid_target' | 'invalid_request' | 'invalid_scope' | 'server_error' | string;
/**
 ...
 */
declare class AnonymousSessionError extends Error {
    /**
     * Machine-readable error code identifying the failure reason.
     * Maps to the `error` field in the Auth0 API response.
     */
    code: AnonymousSessionErrorCode;
    /**
